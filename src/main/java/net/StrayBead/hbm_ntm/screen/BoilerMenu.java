...
public class BoilerMenu extends AbstractContainerMenu {
    ...
    public BoilerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public BoilerMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(NTMModMenus.BOILER_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.BOILER.get());
    }
    ...
    public BoilerBlockEntity getBlockEntity() {
