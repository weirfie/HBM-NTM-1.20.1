...
public class FatManMenu extends AbstractContainerMenu {
    public final FatManBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public FatManMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public FatManMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(NTMModMenus.FAT_MAN_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (FatManBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.FAT_MAN.get());
    }
    ...
    public FatManBlockEntity getBlockEntity() {
