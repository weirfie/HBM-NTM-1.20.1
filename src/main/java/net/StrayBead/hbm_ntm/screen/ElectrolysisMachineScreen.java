...
public class ElectrolysisMachineScreen extends AbstractContainerScreen<ElectrolysisMachineMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(HBMNTM.MOD_ID,"textures/screens/electrolysis_machine_gui.png");
    private FluidTankRenderer renderer;
    private FluidTankRenderer outputRenderer;

    public ElectrolysisMachineScreen(ElectrolysisMachineMenu menu, Inventory inventory, Component component) {
    ...
    private void assignEnergyInfoArea() {
        ...
        energyInfoArea = new EnergyInfoArea(x + 186, y + 3, menu.blockEntity.getEnergyStorage(), 16, 89);
    }
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        int x = (width - imageWidth) / 2;
        int y = (height - imageHeight) / 2;
        pGuiGraphics.drawString(this.font, Component.literal("Electrolysis Machine"), 38, -11, -1, false);
        ...
        renderOutputTooltip(pGuiGraphics, pMouseX, pMouseY, x, y, 107, 23, menu.getTank2());
    }
    ...
    private void renderEnergyAreaTooltips(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, int x, int y) {
        if(isMouseAboveArea(pMouseX, pMouseY, x, y, 186, 3, 16, 89)) {
    ...
    protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        pGuiGraphics.blit(TEXTURE, this.leftPos, this.topPos - 15, 0, 0, 256, 256, 256, 256);
        ...
        outputRenderer.render(pGuiGraphics, x + 107, y + 23, menu.getTank2());
    }
