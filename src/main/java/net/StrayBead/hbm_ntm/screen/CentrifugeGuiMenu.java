...
public class CentrifugeGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public CentrifugeGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData, net.minecraft.world.inventory.ContainerData data) {
        super(NTMModMenus.CENTRIFUGE_GUI.get(), id);
        ...
        this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 39, 35) {
    ...
    public int getScaledProgress() {
        ...
        return maxProgress != 0 && progress != 0 ? progress * 18 / maxProgress : 0; // 18 is the width of the arrow
    }
