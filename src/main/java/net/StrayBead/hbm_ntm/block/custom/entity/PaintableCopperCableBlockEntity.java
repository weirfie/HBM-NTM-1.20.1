...
public class PaintableCopperCableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
    ...
    public PaintableCopperCableBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntites.PAINTABLE_COPPER_CABLE_ENTITY.get(), pPos, pBlockState);
    }
    ...
    public Component getDisplayName() {
        return Component.literal("Coppercable");
    }
    ...
    public final EnergyStorage energyStorage = new EnergyStorage(400000, 40000, 40000, 0) {
        @Override
